...
public class Ponketmon3_1 {

        /*
        * 당신은 폰켓몬을 잡기 위한 오랜 여행 끝에, 홍 박사님의 연구실에 도착했습니다.
홍 박사님은 당신에게 자신의 연구실에 있는 총 N 마리의 폰켓몬 중에서 N/2마리를
가져가도 좋다고 했습니다.
...
따라서 최대 고를 수 있는 폰켓몬 종류의 수는 2입니다.
        ...
        * */
        ...
        public int solution(int[] nums) {
            ...
            Map<Integer, Integer> ponketball = new HashMap<>();
            for(Integer num : nums){
                ponketball.put(num, num);
            }
            int n = nums.length / 2;

            for(Integer key : ponketball.keySet()){
                ponketball.get(key);
                answer +=1;
            }
